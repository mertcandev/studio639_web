...
import 'package:flutter_web_app/components/contactus_appbar.dart';
import 'package:flutter_web_app/pages/arch_aboutus_page.dart';
import 'package:google_fonts/google_fonts.dart';

import '../pages/welcome_page.dart';

class ArchProjectsAppBar extends StatelessWidget {
  const ArchProjectsAppBar({super.key});
        ...
        children: [
          ...
          InkWell(
            onTap: () {
              Navigator.of(context).push(MaterialPageRoute(
                  fullscreenDialog: true,
                  builder: (context) => const ContactUsAppBar()));
            },
            child: Text(
              "iletişim",
              style:
